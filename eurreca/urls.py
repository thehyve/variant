...
urlpatterns = patterns('',
    ...
    (r'^all/$', 'eurreca.views.all'), 
    (r'^faq/$', 'eurreca.views.faq'), 
    ...
    (r'^studies/update/(\w+)$', 'eurreca.views.study_update'),
    (r'^studies/view/(\w+)$', 'eurreca.views.study_view'),
    (r'^studies/remove/(\w+)$', 'eurreca.views.study_remove'),
    (r'^snp_search/(\w+)$', 'eurreca.views.snp_search'),
    (r'^ajax_snp/(\w+)$', 'eurreca.views.ajax_snp'),
